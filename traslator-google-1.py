...
def traduzir_arquivos():
    ...
    for i, arquivo in enumerate(arquivos, start=1):
        ...
        try:
            ...
            # Criando o nome numérico para o arquivo de saída
            novo_nome = f"{i:03d}_traduzido.txt"  # Exemplo: 001_traduzido.txt
...
janela.geometry("500x500")  # Ajuste no tamanho vertical
